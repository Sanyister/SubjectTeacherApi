        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Professorate = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SemesterStudent", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SemesterTeacher", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SemesterStudent_SemesterId",
                table: "SemesterStudent",
                column: "SemesterId");

            migrationBuilder.CreateIndex(
                name: "IX_SemesterStudent_StudentId",
                table: "SemesterStudent",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_SemesterStudent_SubjectId",
                table: "SemesterStudent",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_SemesterTeacher_SemesterId",
                table: "SemesterTeacher",
                column: "SemesterId");

            migrationBuilder.CreateIndex(
                name: "IX_SemesterTeacher_SubjectId",
                table: "SemesterTeacher",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_SemesterTeacher_TeacherId",
                table: "SemesterTeacher",
                column: "TeacherId");
